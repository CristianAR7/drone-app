...
app = Flask(__name__)
CORS(app)
# Usa la variable de entorno de Render, y si no existe (en local), usa sqlite
...
with app.app_context():
    db.create_all()
    # Intentamos importar y ejecutar el script de sembrado
    try:
        from setup_db import seed_database
        seed_database()
    except ImportError:
        print("No se encontró setup_db.py, omitiendo el sembrado.")
